...
namespace GroundCS
{
    class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GroundCS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(GroundCS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(GroundCS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.HeadingIndicator_Aircraft);        
