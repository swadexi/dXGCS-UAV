...
namespace GroundCS
{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GroundCS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(GroundCS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(GroundCS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(GroundCS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.TurnCoordinatorMarks);
