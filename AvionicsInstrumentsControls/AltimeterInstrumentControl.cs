...
namespace GroundCS
{
    class AltimeterInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GroundCS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Altimeter_Background);
        Bitmap bmpSmallNeedle = new Bitmap(GroundCS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.SmallNeedleAltimeter);
        Bitmap bmpLongNeedle = new Bitmap(GroundCS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.LongNeedleAltimeter);
        Bitmap bmpScroll = new Bitmap(GroundCS.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Bandeau_Dérouleur);
